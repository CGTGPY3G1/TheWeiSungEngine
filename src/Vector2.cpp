...
namespace WeiSungEngine {
	...
	const float Vector2::AngleInDegrees() const {
		return AngleInRadians() * WSMath::RadiansToDegrees();
	}
	...
	Vector2 Vector2::RotateInDegrees(const float & angle) {
		return RotateInRadians(angle * WSMath::DegreesToRadians());
	}

	Vector2 Vector2::RotatedInDegrees(const float & angle) {
		return RotatedInRadians(angle * WSMath::DegreesToRadians());
	}
	...
	const float Vector2::AngleToPointInDegrees(const Vector2 & point) const {
		return AngleToPointInRadians(point) * WSMath::RadiansToDegrees();
	}
	...
	Vector2 Vector2::RotateToInDegrees(const float & angle) {
		return RotateToInRadians(angle * WSMath::DegreesToRadians());
	}
